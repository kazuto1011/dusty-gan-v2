...
__global__ void ChamferDistanceKernel(int b, int n, const float *xyz, int m,
...
void ChamferDistanceKernelLauncher(const int b, const int n, const float *xyz,
                                   const int m, const float *xyz2,
                                   float *result, int *result_i, float *result2,
                                   int *result2_i) {
  ChamferDistanceKernel<<<dim3(32, 16, 1), 512>>>(b, n, xyz, m, xyz2, result,
                                                  result_i);
  ChamferDistanceKernel<<<dim3(32, 16, 1), 512>>>(b, m, xyz2, n, xyz, result2,
                                                  result2_i);
...
__global__ void ChamferDistanceGradKernel(int b, int n, const float *xyz1,
...
void ChamferDistanceGradKernelLauncher(const int b, const int n,
